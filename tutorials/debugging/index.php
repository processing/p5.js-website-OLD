  ...
  <div class="column-span">
    ...
    <section>
      ...
      <img src="assets/0-0.jpg" />
        ...
        <a class="anchor" href="#file-setup"><h3 class = "start-element tutorial-btn" id = "introduction">0. Debugging is a Creative Act</h3></a>
        <div class="info" id="introduction">
          <p>
            At all levels programmers encounter bugs and will often spend more time debugging than actually programming the application. You can expect to spend allot of time doing this and so it is important to develop good strategies for identifying and working through bugs as you learn to program in p5.js.    </p>
            <p>
              ...
              <p>
                ...
                <a name="1" class="anchor"><h3 class = "start-element tutorial-btn" id = "Change Perspectives">1. Change Perspectives.</h3></a>
                <div class="info" id = "Change perspectives">
                  <p>  Don't panic. </p>
                  <p>  When you encounter a bug that you do not know how to solve, stop, pause and take a deep breath. Stand up, say hi to the dog, take a walk or if it's late go get some sleep. When you are frustrated, tired and upset, you are not in a good frame of mind to learn or solve a  problem.
                  </p>
                  <p>  To find your errors you will need to change perspectives and become the detective. The goal is to find out what the program IS doing, rather than why it's not doing what it's supposed to. We need to get the computer to show us what it's doing.
                  </p>
                  <p>  The clues are in the values of variables and flow of program.
                  </p>
                  <img class="small_center" img src="assets/1-0.jpg" />
                </div>

                <a name="2" class="anchor"><h3 class = "start-element tutorial-btn" id = "problem">2. Observe the problem </h3></a>
                <div class = "info" id = "problem">
                  ...
                  <a name="3" class="anchor"><h3 class = "start-element tutorial-btn" id = "start">3. Before you start... </h3></a>
                  <div class = "info" id = "start">
                    ...
                    <p>
                      ...
                      <p>If you make a mistake or your problem gets more worse, you can always UNDO or revert back to your saved file.

                      </p>
                      <img class="med_center" img src="assets/3-3.jpg" />
                    </br>
                    <p>
                    ...
                    <div class = "info" id = "basics">
                      <p>
                        ...
                        <ul>
                          ...
                          <p>
                            <p>
                              <a name="5" class="anchor"><h3 class = "start-element tutorial-btn" id = "blackboxes">5. Black boxes</h3></a>
                              ...
                              <a name="6" class="anchor"><h3 class = "start-element tutorial-btn" id = "reporting">6. Add error reporting  </h3></a>
                              <div class = "info" id = "reporting">
                                ...
                                <p>It is also useful to add in console.log()s to print out values of variables so that you can see what they are doing.
                                  <img class="med_center" img src="assets/6-3.jpg" />
                                </p>

                                <a name="7" class="anchor"><h3 class = "start-element tutorial-btn" id = "help">7. Search for more help </h3></a>
                                <div class = "info" id = "help">
                                  <p>
                                    ...
                                    <ul>
                                      <li>
                                        First chapter of <a href="http://jqfundamentals.com/chapter/javascript-basics">Bocoup's and Rebecca Murphey's interactive textbook, jQuery Fundamentals.</a>
                                      </li><li>
                                        <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide">  Mozilla's JavaScript Guide</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference ">JavaScript Reference </a>(this is really helpful for finding all of the built-in methods for, say a String.)
                                      </li><li>
                                        <a href="https://github.com/lmccart/itp-creative-js#js-learning--intro">Resources from Lauren.</a>
                                      </li>
                                    </ul>
                                    <image class ="med_center" img src="assets/7-1.jpg" />


                                    <a name="8" class="anchor"><h3 class = "start-element tutorial-btn" id = "people">8. Ask people </h3></a>
                                    <div class = "info" id = "people">
                                      <p>
                                        Still not working?
                                        <img class="med_right" img src="assets/8-0.jpg" />

                                          You can also ask people for help! They might be delighted to help you.  <p/>
                                          <p>Send that email you wrote at the start.  <br/>
                                            Post to the Processing forum succinctly articulating your problem and what you want to know. <br/>
                                          </p>

                                          <a name="9" class="anchor"><h3 class = "start-element tutorial-btn" id = "prevent">9. Good coding practices and how to prevent bugs!</h3></a>
                                          <div class = "info" id = "prevent">
                                            ...
                                            <a name="10" class="anchor"><h3 class = "start-element tutorial-btn" id = "help">10. More resources </h3></a>
