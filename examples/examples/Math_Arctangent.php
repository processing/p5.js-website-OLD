  ...
  <body id="learn-page">
    ...
    <div class="column-span">
      <section>
          ...
          <h2>Arctangent</h2>
          <p>Move the mouse to change the direction of the eyes.<br>The atan2() function computes the angle from each eye to the cursor.
 </p>
    ...
    <script>
      $(document).ready( function () {
          examples.init('../examples_src/08_Math/15_arctangent.js');
      });
    </script>
  </body>
</html>