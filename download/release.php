...
function updateFiles() {
  global $lib_version;
  $r = 'https://github.com/processing/p5.js/releases/download/'.$lib_version;
  download($r.'/p5.min.js', '/p5.min.js');
  download($r.'/addons/p5.dom.js', '/p5.dom.js');
  download($r.'/addons/p5.sound.js', '/p5.sound.js');
}
